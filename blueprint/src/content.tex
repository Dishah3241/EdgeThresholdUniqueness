...
\chapter{Uniqueness of K_{d+2} at C(d+2,2) edges for d >= 6}

\begin{definition}[Pairwise coprimality]
  \label{def:pairwise-coprime}
  \lean{EdgeThresholdUniqueness.Standalone.Mathlib.PairwiseCoprime}
  \leanok
...
\begin{lemma}[Small primes are pairwise coprime]
  ...
  \lean{EdgeThresholdUniqueness.Standalone.Mathlib.SmallPrimesCoprime}
  \leanok
