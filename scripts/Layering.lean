...
private def auditedRoot : Name := `EdgeThresholdUniqueness
...
private def generalRoots : Array Name := #[
  `EdgeThresholdUniqueness.Algebra,
  `EdgeThresholdUniqueness.Analysis,
  `EdgeThresholdUniqueness.Combinatorics,
  `EdgeThresholdUniqueness.Data,
  `EdgeThresholdUniqueness.FieldTheory,
  `EdgeThresholdUniqueness.LinearAlgebra,
  `EdgeThresholdUniqueness.NumberTheory,
  `EdgeThresholdUniqueness.Order,
  `EdgeThresholdUniqueness.RingTheory,
  `EdgeThresholdUniqueness.SetTheory,
  `EdgeThresholdUniqueness.Topology,
]
...
private def subjectRoots : Array (Name × String) := #[
  -- (`EdgeThresholdUniqueness.YourSubject`, "your subject"),
]
